...
*/
Vue.component("simple_footer_component_1721817920", {
    template: `
            ...
            <div id="footer-container" class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
                ...
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the curve with BlockScan. Our cutting-edge analytics engine processes and visualizes the latest blockchain data, giving you real-time insights to drive your decentralized applications forward. From smart contract monitoring to on-chain metric tracking, BlockScan is your go-to platform for advanced blockchain analysis.
                    </div>
                </div>
            </div>
        </footer> 
